...
short tutorial — **[Planning tools](/docs/planning-tools)** — covering both tool
...
implement `stream()` yourself. It has its own short tutorial —
...
policy. It has its own short tutorial —
**[Gating tool calls](/docs/gating-tool-calls)** — covering the permission policy

 ...
 * subpath (`@open-agent-loops/agent-loop-core/providers/openai`), so consumers who bring their own
 ...
 * import { Role, StreamEventType } from "@open-agent-loops/agent-loop-core";
 *
